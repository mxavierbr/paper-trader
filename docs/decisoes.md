...
**Decisão:** nome **Trendo** (derivado de "trend", tendência). Por enquanto sem slogan: topo, título da aba e tela de abertura do app mostram só o logo e "Trendo". Frases avaliadas e guardadas para depois: "Cada ação, sua tendência." e "Informação que vira decisão.". Logo: um "t" cuja barra vira linha de tendência de alta, com ponto dourado no destino. Arquivos em `assets/` (SVG, PNGs 180/192/512 e manifest para instalar no celular).
